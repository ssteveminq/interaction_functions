...
from gaze_service.srv import gaze_target
...
class Gaze_manager(object):
    def __init__(self, wait=0.0):
        ...
        # rospy.wait_for_service('gaze_see_target')
        self.srv_client=rospy.ServiceProxy('gaze_see_target', gaze_target)
    ...
    def gaze_target_callback(self, data):
        ...
        self.x_map= data.pose.position.x
        self.y_map= data.pose.position.y
        
        rospy.wait_for_service('gaze_see_target')
        try:
            self.srv_client(self.x_map,self.y_map)
...
if __name__ == '__main__':
    rospy.init_node('gazeservice_manager_test')
